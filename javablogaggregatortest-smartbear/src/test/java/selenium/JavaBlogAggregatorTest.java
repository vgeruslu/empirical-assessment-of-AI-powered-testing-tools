...
public class JavaBlogAggregatorTest {
    ...
    public void testRegister() throws Throwable {
       ...
       javaBlogAggregatorPage.clickRegisterLink();
        ...
        VisualTest visualTest = new VisualTest(driver, "gnzaGJvy/EnLZRTH99oI=");
		visualTest.capture("LoginPage");
    ...
    public void testCreateNewBlog() throws Throwable {
        ...
        VisualTest visualTest = new VisualTest(driver, "gnzaGJvy/EnLZRTH99oI=");
        visualTest.capture("NewBlogPage");
        visualTest.printReport();
        TestRunResult result = visualTest.getTestRunResult();
        assert result.getFailed() == 0;
    ...
    public void testEditBlogName() throws Throwable {
        ...
        VisualTest visualTest = new VisualTest(driver, "gnzaGJvy/EnLZRTH99oI=");
        visualTest.capture("RegisterPage");
        visualTest.printReport();
        TestRunResult result = visualTest.getTestRunResult();
        assert result.getFailed() == 0;
    ...
    /**
     * Description: This test edits a blog's short name
     */
    @Test
    ...
    /**
     * Description: This test edits a blog's nick
     */
    @Test
    ...
    /**
     * Description: This test edits a blog's RSS URL
     */
    @Test
    ...
    public void testAdminRemoveBlog() throws Throwable {
        ...
        VisualTest visualTest = new VisualTest(driver, "gnzaGJvy/EnLZRTH99oI=");
        visualTest.capture("AdminBlogsPage");
        visualTest.printReport();
        TestRunResult result = visualTest.getTestRunResult();
        assert result.getFailed() == 0;
